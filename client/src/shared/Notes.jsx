...
const filters = [
    {
        ...
        options: [
            ...
            { value: 'third', label: 'Third Year', checked: true },
            { value: 'fouth', label: 'Fourth Year', checked: false },
    ...
    },
    {
        ...
        options: [
            ...
            { value: 'fifth', label: 'Fifth Semester', checked: true },
    ...
    },
    {
        ...
        name: 'Subjects',
        options: [
            { value: 'dlcd', label: 'DLCD', checked: false },
            { value: 'maths', label: 'Maths', checked: false },
            { value: 'oops', label: 'Oops', checked: false },
            { value: 'dc', label: 'Data Communication', checked: true },
            { value: 'idt', label: 'IDT', checked: false },
    ...
    },
    {
        ...
        name: 'Type',
        options: [
            { value: 'pyq', label: 'PYQ', checked: false },
            { value: 'notes', label: 'Notes', checked: true },
            { value: 'file', label: 'Files', checked: false },
        ],
    }
]
                ...
                <div className='Page1'>
                    <div className="bg-white">
                        <div>
                            ...
                            <main className="mx-auto max-w-7xl sm:px-6 lg:px-2">
                                <div className="flex items-baseline justify-between border-b border-gray-200 py-10">
                                    <h1 className="text-5xl font-bold tracking-tight text-gray-900">Explore Notes</h1>
                                    ...
                                    <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                                        ...
                                        <div className="lg:col-span-3 px-5 flex flex-wrap gap-10">
                                            ...
                                            <div className='w-[25%] h-[50vh] bg-white flex flex-col text-black border border-[#093A3E] p-2 rounded'>
                                                <div className='w-[90%] mx-auto h-[40vh] border mt-2'>

                                                </div>
                                                <a href='' className='mainf text-xl font-semibold mt-2 leading-0'>
                                                    Notes Title
                                                </a>
                                                <p className='text-zinc-600'><small>12 April 2024</small></p>
                                            </div>
