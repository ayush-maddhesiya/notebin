...
declare module '~blue-tape~es6-promise/dist/es6-promise' {
...
import {Thenable} from '~blue-tape~es6-promise/dist/es6-promise';
import tape = require('~blue-tape~tape/index');

module '~blue-tape~tape/index' {
  interface Test {
